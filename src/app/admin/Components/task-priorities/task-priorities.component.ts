...
import { TaskPrioritieService } from 'src/app/services/task-priorities.service';
...
export class TaskPrioritiesComponent implements OnInit {
  ...
  //Constructor
  constructor(private taskPrioritiesService: TaskPrioritieService, private formBuilder: FormBuilder) {
  }
